  ...
  <BaseModal :open="props.open">
    ...
    >
      <div class="flex flex-row-reverse gap-3">
        ...
        <button
          type="button"
          class="mt-3 inline-flex w-full justify-center rounded-md border border-red-600 dark:border-red-700 bg-red-600 dark:bg-red-800 px-4 py-2 font-medium text-white dark:text-slate-200 shadow-sm hover:bg-red-500 dark:hover:bg-red-700 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 sm:mt-0 sm:w-auto sm:text-sm"
      ...
      <div class="flex gap-3">
        <a
          ...
          class="mt-3 inline-flex w-full justify-center items-center rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2 text-base font-medium text-slate-800 dark:text-slate-200 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-slate-800 dark:hover:text-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 sm:mt-0 sm:w-auto sm:text-sm"
        >
